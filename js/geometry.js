...
(function (global) {
  ...
  global.NaidesuGeometry = api;
  global.SNCR2Geometrics = api; // SNCR2 別名（qr-geometry.js とは別物）
  // Node からも require できるよう module.exports へも公開（無改造の趣旨は
  // 「ロジックに手を入れない」ことなので、輸出口の追加のみ行う）。
